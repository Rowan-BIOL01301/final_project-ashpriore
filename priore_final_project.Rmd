...
pizza_barstool%>% #giving this dataset to next function
  ...
  geom_histogram(fill= "mediumspringgreen", color= "black")+ #specifying type of plot and fill and color
...
The distribution of Dave's total score is skewed to the right.
